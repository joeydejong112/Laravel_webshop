                    ...
                    <div class="row">
                        <div class="col-lg-8" style="text-align: left  ">
                            <img src="{{ $item->attributes->image }}" class="img-thumbnail" width="200" height="200">
                             <p>
                                <b><a href="/product/{{ $item->attributes->slug }}">{{ $item->name }}</a></b><br>
                            ...
                            <div class="row">
                                <form action="{{ route('cart.update') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <button class="btn btn-secondary " style="width:100%;" ><i class="fa fa-edit"> Update</i></button>
                                    </div>
                                </form>
                                <form action="{{ route('cart.remove') }}" method="POST">
                                    {{ csrf_field() }}
                                    <input type="hidden" value="{{ $item->id }}" id="id" name="id">
                                    <button class="btn btn-dark btn-sm" style="width:100%;" ><i class="fa fa-trash"> Delete</i></button>
                                </form>
                            </div>
                        </div>
                    </div>
